...
const projects = [
  {
    emoji: '🌾',
    title: 'FarmTracker',
    subtitle: 'AI-Based Scheduler for Farming',
  ...
  return (
    <section id="projects" style={{ padding: '6rem var(--pad)', maxWidth: 'var(--max-w)', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3rem' }}>
        <h2 style={{
          fontFamily: 'var(--serif)', fontSize: 36, letterSpacing: '-0.5px', lineHeight: 1.2,
        }}>
          Things I've<br />
          <em style={{ fontStyle: 'italic', color: 'var(--ink-2)' }}>built & shipped</em>
        </h2>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
        {projects.map((p, i) => (
          <div key={i}
            ...
            style={{
              background: 'var(--bg)', border: `1px solid ${hovered === i ? 'var(--line-strong)' : 'var(--line)'}`,
            ...
            {p.highlight && (
              <div style={{
                ...
                border: '1px solid rgba(42,106,74,0.2)',
              }}>Featured</div>
            )}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{
                  ...
                  padding: '1rem 1.25rem', borderLeft: '3px solid var(--accent)',
                }}>
      ...
      <style>{`
        @media (max-width: 640px) {
          #projects .proj-inner { grid-template-columns: 1fr !important; }
        }
      `}</style>
    </section>
  );
