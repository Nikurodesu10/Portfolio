...
const events = [
  {
    title: 'GDG DevFest Bacolod 2025',
    org: 'University of St. La Salle – Bacolod City',
    date: 'November 2025',
    desc: 'Attended Google Developer Group DevFest, exploring the latest in web, mobile, and AI development technologies.',
    tag: 'Tech Conference',
  },
  {
    title: 'TechTrack: Mapping Your Future Tech',
    org: 'University of St. La Salle – Bacolod City',
    date: 'November 2025',
    desc: 'Career guidance seminar focused on navigating tech career pathways and emerging opportunities in the industry.',
  ...
  },
  {
    ...
    org: 'University of St. La Salle – Bacolod City',
    date: 'August 2025',
    desc: 'Seminar exploring the role of cybersecurity in protecting national infrastructure and digital governance.',
    tag: 'Cybersecurity',
  },
  {
    title: 'CS Expo 3.0 Pitching Competition',
    org: 'University of St. La Salle – Bacolod City',
    date: 'April 2025',
    desc: 'Participated in the college's annual computing expo, presenting and pitching innovative tech projects.',
    tag: 'Competition',
  },
];
...
export default function Blog() {
  return (
    <section id="blog" style={{ padding: '6rem var(--pad)', maxWidth: 'var(--max-w)', margin: '0 auto' }}>
      <Label>Seminars & Events</Label>

      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '3rem' }}>
        <h2 style={{ fontFamily: 'var(--serif)', fontSize: 36, letterSpacing: '-0.5px', lineHeight: 1.2 }}>
          Learning &amp;<br />
          <em style={{ fontStyle: 'italic', color: 'var(--ink-2)' }}>growing</em>
        </h2>
        <p style={{ fontSize: 13, color: 'var(--ink-3)', maxWidth: 200, textAlign: 'right', lineHeight: 1.6 }}>
          Conferences, workshops &amp; events I've attended
        </p>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        {events.map((e, i) => (
          <div key={i} style={{
            ...
            boxShadow: 'var(--shadow-sm)', gap: '1rem', alignItems: 'center',
            transition: 'all 0.2s',
          }}
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
                ...
                <span style={{
                  ...
                  background: tagColor[e.tag]?.bg || '#f0f0f0',
                  color: tagColor[e.tag]?.color || '#555',
                }}>{e.tag}</span>
              </div>
